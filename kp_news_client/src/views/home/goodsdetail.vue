<template>
  <div class="home">
    ...
    <div class="record">
      ...
      <div class="likeimg" @click="addLikecountitem()">
        点赞 {{goods.likecount}}
...
<script>
import { getGoodsDetailById, addLikecount } from "@/api/goods.js";
    ...
    async AddCollectionitem(id, title) {
      ...
      if (userid === undefined) {
        ...
        try {
          ...
          this.collectionItem.articleid = id;
          this.collectionItem.videoid = "0";
    ...
    async addLikecountitem() {
      ...
      if (this.clicklike == true) {
        ...
        try {
          ...
          let params = { id: this.id };
          console.log(params);
          let result = await addLikecount(params);
          if (result.code === "0") {
            console.log(result);
            this.getGoodsInfo();
            Toast.success("点赞成功");
